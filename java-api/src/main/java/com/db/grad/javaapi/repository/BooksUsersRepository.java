...
{
    @Query(nativeQuery = true, value = "select b.bookname, bu.bondholder, b.status, b.issuername, b.isin, b.cusip, b.facevalue, b.bondmaturitydate, b.bondcurrency, b.couponpercent, b.unitprice\n" +
